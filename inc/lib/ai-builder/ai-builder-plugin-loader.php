...
class Ai_Builder_Plugin_Loader {
	...
	public function get_localize_variable() {
		...
		return array(
			...
			'siteUrl'                  => site_url(),
                        'pageTitle'                => __( 'Build with AI', 'astra-sites' ),
                        'openInNewTabLabel'       => __( 'Open in a new tab', 'astra-sites' ),
                        'loadingMessage'          => __( 'Loading AI Builder…', 'astra-sites' ),
                        'errorMessage'            => __( 'We couldn\'t load the AI Builder. Please use the button above to open it in a new tab.', 'astra-sites' ),
                        'iframeTitle'             => __( 'AI Site Builder', 'astra-sites' ),
                        'screenUrl'               => ZIPWP_APP,
